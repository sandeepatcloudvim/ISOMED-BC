report 50002 "CBR Sales Order Acknowledgment"
{
    // CBR_SS : 28/02/2018 : Added code to display Lot No.
    DefaultLayout = RDLC;
    RDLCLayout = './SalesOrderAcknowledgmentCBR.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(BilltoNameCBR; "Sales Header"."Sell-to Customer Name")
            {
            }
            column(BilltoContactCBR; "Sales Header"."Sell-to Contact")
            {
            }
            column(BilltoAddress1CBR; "Sales Header"."Sell-to Address")
            {
            }
            column(BilltoAddress2CBR; "Sales Header"."Sell-to Address 2")
            {
            }
            column(BilltoCityCBR; "Sales Header"."Sell-to City")
            {
            }
            column(BilltoStateCBR; "Sales Header"."Sell-to County")
            {
            }
            column(BilltoZipCBR; "Sales Header"."Sell-to Post Code")
            {
            }
            column(CreationTime; "Sales Header"."CBR Creation Time")
            {
            }
            column(CreatedByUserName; "Sales Header"."CBR Created By User Name")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ShipmentTrackingNo; "Sales Header"."Package Tracking No.")
                    {
                    }
                    ...
                    column(Comments; "Sales Header".Comment)
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(Description2_CBR; recItem."Description 2")
                        {
                        }
                        ...
                        column(LineAmt_SalesLinewithTax; "Sales Line"."Amount Including VAT")
                        {
                        }
                        ...
                        begin
                            ...
                            if ExpDate <> '' then
                                LotNoValue := 'Lot No.: ' + LotNoValue + ' , Exp. Date: ' + ExpDate;
            ...
            trigger OnPostDataItem()
            begin
                //MESSAGE('%1',"Sales Header"."Creation Time");
            end;

            trigger OnPreDataItem()
            begin
                Print := Print or not CurrReport.Preview;
                Tot := 0;  //CBR_SS_01032018
            end;
        }
    }
