report 50033 "Check (Stub/Check/Stub) CBR"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CheckStubCheckStubCBR.rdl';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            trigger OnAfterGetRecord()
            var
                JournalAccounType: Enum "Gen. Journal Account Type";
            ...
            begin
                ...
                if not TestPrint then begin
                    ...
                    TestField("Bal. Account Type", JournalAccounType::"Bank Account");
                    if "Bal. Account No." <> BankAcc2."No." then
                        CurrReport.Skip;
