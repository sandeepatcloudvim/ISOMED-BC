report 50043 "CBR Item Sales by Customer"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ItemSalesbyCustomer.rdl';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            dataitem("Item Ledger Entry"; "Item Ledger Entry")
            {
                ...
                column(PriceGroup; Cust."Customer Price Group")
                {
                }
    ...
    begin
        ...
        ExcelBuf.AddColumn(Format(Text115), false, '', true, false, true, '', ExcelBuf."Cell Type"::Text); //CBR_SS>><<
    ...
    begin
        ...
        ExcelBuf.AddColumn(Cust."Customer Price Group", false, '', false, false, false, '', ExcelBuf."Cell Type"::Text); //CBR_SS>><<
