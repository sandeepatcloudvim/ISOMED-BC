report 50016 "Banner Health Sales"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BannerHealthSales.rdl';
        ...
        dataitem(Customer; Customer)
        {
            dataitem("Sales Invoice Header"; "Sales Invoice Header")
            {
                ...
                dataitem("Sales Invoice Line"; "Sales Invoice Line")
                {
                    ...
                    DataItemTableView = SORTING("Document No.", "Line No.") WHERE("Customer Price Group" = FILTER('BANNER HEA'), Quantity = FILTER(<> 0));
