report 50034 "Purchase Order -IsoMed"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PurchaseOrderIsoMed.rdl';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BuyFromNameCBR; "Purchase Header"."Buy-from Vendor Name")
                    {
                    }
                    column(BuyFromContactCBR; "Purchase Header"."Buy-from Contact")
                    {
                    }
                    column(BuyFromAddress1CBR; "Purchase Header"."Buy-from Address")
                    {
                    }
                    column(BuyFromAddress2CBR; "Purchase Header"."Buy-from Address 2")
                    {
                    }
                    column(BuyFromCityCBR; "Purchase Header"."Buy-from City")
                    {
                    }
                    column(BuyFromStateCBR; "Purchase Header"."Buy-from County")
                    {
                    }
                    column(BuyFromZIPCBR; "Purchase Header"."Buy-from Post Code")
                    {
                    }
                    ...
                    column(ShipmentMethodCode_CBR; ShipmentMethod.Code)
                    {
                    }
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        column(POLineNumberCounter; POLienNumberCounter)
                        {
                        }
                        ...
                        begin
                            ...
                            POLienNumberCounter := POLienNumberCounter + 1;
                        ...
                        begin
                            POLienNumberCounter := POLienNumberCounter + 1;  //Added by CBR
                        end;
