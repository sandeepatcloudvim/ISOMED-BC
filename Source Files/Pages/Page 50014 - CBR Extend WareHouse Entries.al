pageextension 50014 CBRExtendWareHouseEntries extends "Warehouse Entries"
{
    layout
    {
            ...
            group(CBRIncomingDocument)
            {
                ...
                action("CBR SelectIncomingDoc")
                {
                    ...
                    var
                        IncomingDocument: Record "Incoming Document";
                    begin
                        IncomingDocument.SelectIncomingDocumentForPostedDocument(FORMAT("Entry No."), WORKDATE, RECORDID);   //CBR_SS
                    end;
                }
                ...
                action("CBR IncomingDocAttachFile")
                {
                    ...
                    begin
                        IncomingDocumentAttachment.CBRNewAttachmentFromWareHouseEntry(Rec, "Lot No.", "Item No.", "Variant Code");//CBR_SS
                    end;
                }
            }
        }
