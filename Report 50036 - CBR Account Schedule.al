report 50036 "CBR Account Schedule"
{
    DefaultLayout = RDLC;
    RDLCLayout = './AccountSchedule.rdl';
    ...
    requestpage
    {
        ...
        begin
            ...
            //CBR_SS>>
            AccSchedName := 'ISO-PL-M';
            ColumnLayoutName := 'ISO-PL-MM';
            //CBR_SS<<
        end;
        ...
        begin
            GLSetup.Get;
            TransferValues;
            if (AccSchedName <> '') and (ColumnLayoutName = '') then
                ValidateAccSchedName;
            SetBudgetFilterEnable;
        end;
    }
