report 50028 "Sales Invoice - Print Job"
{
    // CBR_SS : 02/03/2018 : Added code to display Lot No.
    RDLCLayout = './SalesInvoicePrintJob.rdl';
    WordLayout = './SalesInvoicePrintJob.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(SalInvLine; "Sales Invoice Line")
            {
                ...
                column(Description_SalInvLine; SalInvLine.Description)
                {
                }
                ...
                begin
                    ...
                    i := 0;
                    IF SalInvLine.FINDSET THEN REPEAT
                      i := i + 1;
                      IF i <=5 THEN
