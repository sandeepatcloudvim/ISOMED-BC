report 50009 "Purchase Order Shipment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PurchaseOrderShipment.rdl';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            RequestFilterFields = "No.", "Buy-from Vendor No.", "Pay-to Vendor No.", "No. Printed", "Posting Date";
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(POShipmentReportCaption; ReportCaptionLbl)
                    {
                    }
                    ...
                    dataitem("Purch. Rcpt. Line"; "Purch. Rcpt. Line")
                    {
                        ...
                        column(ExtendedUnitCaption; ExtendedUnitCaptionLbl)
                        {
                        }
                        column(UnitPriceCaption; UnitPriceCaptionLbl)
                        {
                        }
                        column(ExpectedDateCaption; ExpectedCaptionLbl)
                        {
                        }
                        ...
                        column(UnitPriceLCY_PurchRcptLine; ExtendedCost)
                        {
                        }
                        column(UnitCostLCY_PurchRcptLine; "Purch. Rcpt. Line"."Unit Cost (LCY)")
                        {
                        }
                        column(ExpectedReceiptDate; "Purch. Rcpt. Line"."Expected Receipt Date")
                        {
                        }
                        ...
                        begin
                            ...
                            if ItemLedgerEntry.FindFirst then begin
                                ...
                                ExtendedCost := ItemLedgerEntry."Cost Amount (Actual)";
                            end;
    ...
    begin
        ...
        DateFilter := "Purch. Rcpt. Header".GetFilter("Posting Date");
    end;
    ...
    var
        ...
        ExtendedUnitCaptionLbl: Label 'Extended Unit Price';
        UnitPriceCaptionLbl: Label 'Unit Price';
        ExpectedCaptionLbl: Label 'Receipt Date';
        UnitOfMeasureCaptionLbl: Label 'UOM';
        ReportCaptionLbl: Label 'PO Shipment Report';
