report 50011 "Vizient Sales"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VizientSales.rdl';
        ...
        dataitem(Customer; Customer)
        {
            dataitem("Sales Invoice Header"; "Sales Invoice Header")
            {
                ...
                dataitem("Sales Invoice Line"; "Sales Invoice Line")
                {
                    ...
                    DataItemTableView = SORTING("Document No.", "Line No.") WHERE("Customer Price Group" = FILTER('VIZIENT'), Quantity = FILTER(<> 0));
